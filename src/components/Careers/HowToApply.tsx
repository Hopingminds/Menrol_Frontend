    ...
    return (
        <section className="p-8 bg-gray-100 px-[10%]">
            ...
            <div className="bg-[rgba(36,35,42,1)] text-white p-8 text-center rounded-xl shadow-md w-[100%]  h-72   ">
                ...
                <p className="text-lg mb-4 mt-4 font-dm-sans font-dm-sans tracking-wide leading-relaxed xsm:text-sm">Be a part of our expert team and bring cleanliness and joy to every
                    space.</p>
