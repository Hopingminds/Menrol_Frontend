        ...
        <section className="p-8 bg-white px-[10%]">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 font-lexend font-dm-sans tracking-wide leading-relaxed md:text-[30px] xsm:text-sm">Witness Our service Magic Explore Now</h1>
                </div>
