        ...
        <div className="grid grid-cols-[1fr,2.5fr] xsm:grid-cols-1 xsm:gap-0  lg:gap-10 md:gap-0  2xl:gap-[10%] lg:px-[7%] md:px-[10%] xl:px-[7%] 2xl:px-[7%] gap-4 px-[10%] ">
          <div className="flex-col xsm:relative xsm:bottom-32 xsm:left-48 ">
            <div className="relative bg-[#0054A5]  p-8 xsm:py-2 xsm:p-0  rounded-lg shadow-md text-center col-span-1 lg:h-72 w-72 2xl:w-full xsm:w-28 xsm:h-32 md:w-[90%] lg:w-full  md:h-[14rem] xl:mt-2 2xl:mt-0">
              ...
              <p className="text-black  font-sans md:text-xs font-dm-sans tracking-wide leading-relaxed xsm:text-[7px] xsm:-mb-3 xsm:w-full xsm:tracking-tight xsm:leading-tight lg:text-sm 2xl:mt-3">
