        ...
        <div>
            <div className="mb-12 md:mb-1 mt-4  md:overflow-hidden ">
                ...
                <div className="flex flex-col xsm:items-start md:flex-row md:gap-32 2xl:px-[10%] items-center md:items-start justify-between md:px-[8%] lg:px-[10%] xl:px-[10%]  px-[10%] mt-4">
                    ...
                    <h2 className="text-5xl xsm:text-xl md:text-xl 2xl:text-5xl 2xl:w-[50%]  lg:text-3xl  font-bold text-gray-900 md:w-1/2 font-lexend tracking-wide leading-relaxed ">
            ...
            <div className="grid  ">
                <div className="grid grid-cols-[1fr,2.5fr] xsm:grid-cols-1 xsm:gap-0  lg:gap-10 md:gap-0 2xl:gap-[10%] lg:px-[10%] xl:px-[10%] 2xl:px-[10%] md:px-[10%] gap-4 px-[10%]">
