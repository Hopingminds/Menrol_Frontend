    ...
    <div className="bg-[#0054A5] h-[80vh] 2xl:h-[90vh] xsm:h-[19rem] sm:h-[60vh] xl:h-[28rem] md:h-[20rem] lg:h-[28rem] w-full flex  justify-center  relative xsm:w-full">
      ...
      <div className="absolute bottom-0 w-full flex flex-col items-center gap-6 ">
        <div className="flex flex-row gap-x-6 2xl:space-x-7">
          ...
          <div className="xsm:hidden sm:hidden lg:block  xl:block"><Image
            src="/Images/iPhone12_Screen.png"
            alt="iPhone Screen"
            className="h-[55vh] w-[30vw]  lg:h-[18rem] xl:h-[18rem] 2xl:h-[50vh] 2xl:-top-[1px] xl:w-full xl:relative xl:top-[1px] lg:relative  shadow-sm object-contain ml-[4vw] "
            height={1000}
            width={1000}
          /></div>
        </div>
