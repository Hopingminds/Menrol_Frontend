    ...
    <div className="bg-[#0054A5] h-[100%] pb-10 w-full sm:h-[100%] flex items-center justify-center 2xl:justify-start 2xl:items-start relative">
      ...
      <div className="px-[10%] md:gap-20 2xl:px-0 flex flex-col-reverse md:flex-row w-full justify-between md:items-center 2xl:justify-start 2xl:items-start sm:top-4 2xl:mt-4 ">
        ...
        <div className="flex-1 relative sm:flex sm:justify-center">
          ...
          {/* Overlay Content */}
          <div className="bg-[#24232A] h-[20vw] md:h-[15vw] xsm:h-[19vh] md:p-6 xsm:w-[30vw] md:w-[10vw] w-[10vw] sm:w-[18vw] xsm:relative md: xsm:-top-40 xsm:left-56 rounded-lg text-white absolute top-[50%] left-[50%] transform -translate-x-[20%] sm:translate-x-[30%] md:translate-x-[60%] -translate-y-[50%] sm:-translate-y-[50%] flex items-center justify-center font-lexend 2xl:h-[12vw] 2xl:translate-x-[80%]">
            <Image
