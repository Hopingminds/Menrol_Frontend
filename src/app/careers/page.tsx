        ...
        <section className="bg-white py-16">
            <div className="flex">
                <div className="flex-col text-justify px-24">
                    <p className="text-[rgba(81,220,152,1)] uppercase font-medium text-sm tracking-wide font-lexend ">/JOIN OUR TEAM</p>
                    <h1>Make a Difference with a Rewarding Cleaning Career </h1>
                    <p>Ac eu tortor facilisi pulvinar mattis. Nisl vel integer mauris nunc aliquam nunc ullamcorper tincidunt morbi. </p>
                    <button className="bg-[rgba(0,84,165,1)] rounded-lg">Learn More</button>
                </div>
            ...
            <div className=" px-24 border  flex items-center mx-auto">
                <div className="flex justify-between flex-col">
                    <p className="text-green-500 mt-20 ml-8">/Available job positions</p>
                    <h1 className="text-5xl font-semibold mb-10  ml-8">Current Job Openings:</h1>
