...
const AboutUs: React.FC = () => {
    const missionData = [
        { number: '01', title: 'Excellent Pioneers', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
        { number: '02', title: 'Spotless Solutions', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
        { number: '03', title: 'Healthy Environments', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
        { number: '04', title: 'Sustainable Practices', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
        { number: '05', title: 'Empowered Team', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
        { number: '06', title: 'Lasting Bonds', description: 'Tellus aliquam faucibus imperdiet eget interdum risus diam neque lectus.' },
    ];
    const values = [
        {
            title: 'Excellence in Every Detail',
            description: 'Elit nisl morbi nunc enim pellentesque ultrices ultrices. Sit elementum massa eleifend semper.',
        },
        {
        ...
        <section className="bg-white py-16">
                    ...
                    <div className="flex justify-end w-2/3 mt-6">
                        <div className="flex justify-end">
                            <p className="text-gray-500 md:w-1/2 text-sm self-end  text-justify">
                                Ac eu tortor facilisi pulvinar mattis. Nisl vel integer mauris nuncaliquam
                                nunc ullamcorper tincidunt morbi.
                            </p>
                        </div>
                    </div>
            ...
            <div className="grid ">
                <div className="grid grid-cols-3 gap-4 px-24">
                    ...
                    <div className="flex flex-col items-center justify-center col-span-2">
                        ...
                        <div className="col-span-2 grid grid-cols-2 md:grid-cols-2 gap-20 "> {/* Reduced gap and added margin top */}
                            <Feature
            ...
            <div className="flex items-center  gap-14 mt-12 px-24">
                ...
                <div className="w-1/2 flex flex-col  ">
                    <h1 className="text-black text-4xl font-bold mb-4">Embracing Cleanliness and Beyond:</h1>
                    ...
                    <p className="text-gray-600 text-justify">
                        Scelerisque risus in sagittis malesuada. Praesent nec vestibulum ipsum odio enim
                        risus. Egestas tempor morbi felis faucibus vulputate lorem lectus tortor bibendum.
                        Molestie id aliquam ornare in imperdiet nisi.
                    </p>
                </div>
            </div>
            ...
            <div className="flex justify-center gap-16 items-center bg-[rgba(0,84,165,1)]  h-screen">
                ...
                {/* Second Div */}
                <div className="mx-4">
                    <p className="text-sm font-bold text-green-500">/DISCOUNT UP TO 50%</p>
                    ...
                    <p className="mt-4 text-sm">
                        Ac eu tortor facilisi pulvinar mattis. Nisl vel integer mauris nunc<br />
                        aliquam nunc ullamcorper tincidunt morbi.
                    </p>
                    <p className="mt-4 text-sm font-bold underline cursor-pointer">Contact Us</p>
                </div>
            </div>
